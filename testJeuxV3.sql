...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 09 Juin 2015 à 17:27
...
ALTER TABLE `sorties`
  ...
  ADD CONSTRAINT `fk_Sorties_Plateform1` FOREIGN KEY (`idPlateform`) REFERENCES `plateform` (`idPlateform`) ON DELETE NO ACTION ON UPDATE NO ACTION;
