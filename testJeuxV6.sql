...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 26 Juin 2015 à 09:11
...
(1, 'Final Fantasy X', 2, 'super jeux', '12 et +'),
(2, 'crash bandicoot', 1, 'très bon jeu', 'Tout public'),
(3, 'teet', 5, 'descriptionnnnnnnn', 'classif'),
(4, 'GTA', 2, 'super jeux', '18 et +');
...
INSERT INTO `jeu` (`idJeu`, `idInformation`, `active`) VALUES
(1, 1, 1),
(2, 4, 1);
...
CREATE TABLE IF NOT EXISTS `plateform` (
  ...
  `Nom_Plateform` varchar(45) DEFAULT NULL,
...
INSERT INTO `plateform` (`idPlateform`, `Nom_Plateform`) VALUES
(1, 'type1'),
(2, 'type2');
...
INSERT INTO `site` (`idSite`, `idInformation`, `idPays`, `Lien`) VALUES
(1, 1, 1, 'site1'),
(2, 2, 2, 'site2'),
(3, 4, 1, 'site1');
...
CREATE TABLE IF NOT EXISTS `sorties` (
  ...
  KEY `fk_Sorties_Plateform1_idx` (`idPlateform`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;
...
INSERT INTO `sorties` (`idSorties`, `idInformation`, `idPays`, `idPlateform`, `Date`) VALUES
(1, 1, 1, 1, '2015-05-13'),
(2, 2, 2, 2, '2015-05-07'),
(3, 4, 1, 1, '2015-05-13');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `APIKey` int(6) NOT NULL,
  `APISecret` int(10) NOT NULL DEFAULT '123456789',
...
INSERT INTO `users` (`Email`, `APIKey`, `APISecret`, `IsAdmin`) VALUES
('toto@gmail.com', 123456, 123456789, 1);
...
--
ALTER TABLE `bloc`
  ADD CONSTRAINT `fk_Bloc_Test1` FOREIGN KEY (`idTest`) REFERENCES `test` (`idTest`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `developpeur`
--
ALTER TABLE `developpeur`
  ADD CONSTRAINT `fk_Developpeur_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `editeur`
--
ALTER TABLE `editeur`
  ADD CONSTRAINT `fk_Editeur_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `entete`
--
ALTER TABLE `entete`
  ADD CONSTRAINT `fk_Entete_Auteur1` FOREIGN KEY (`idAuteur`) REFERENCES `auteur` (`idAuteur`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Entete_Image1` FOREIGN KEY (`idImage`) REFERENCES `image` (`idImage`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `genres`
--
ALTER TABLE `genres`
  ADD CONSTRAINT `fk_Genres_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `jeu`
--
ALTER TABLE `jeu`
  ADD CONSTRAINT `fk_Game_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `jeumedia`
--
ALTER TABLE `jeumedia`
  ADD CONSTRAINT `fk_JeuxMedia_jeu1` FOREIGN KEY (`idJeu`) REFERENCES `jeu` (`idJeu`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_JeuxMedia_Media1` FOREIGN KEY (`idMedia`) REFERENCES `media` (`idMedia`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `modeleeco`
--
ALTER TABLE `modeleeco`
  ADD CONSTRAINT `fk_ModeleEco_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `modes`
--
ALTER TABLE `modes`
  ADD CONSTRAINT `fk_Modes_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `note`
--
ALTER TABLE `note`
  ADD CONSTRAINT `fk_Note_Test1` FOREIGN KEY (`idTest`) REFERENCES `test` (`idTest`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `opinion`
--
ALTER TABLE `opinion`
  ADD CONSTRAINT `fk_Opinion_Jeu1` FOREIGN KEY (`idJeu`) REFERENCES `jeu` (`idJeu`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `plateform_media`
--
ALTER TABLE `plateform_media`
  ADD CONSTRAINT `fk_Plateform_Media_Media1` FOREIGN KEY (`idMedia`) REFERENCES `media` (`idMedia`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Plateform_Media_Plateform1` FOREIGN KEY (`idPlateform`) REFERENCES `plateform` (`idPlateform`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `redacteur`
--
ALTER TABLE `redacteur`
  ADD CONSTRAINT `fk_Redacteur_Opinion1` FOREIGN KEY (`idOpinion`) REFERENCES `opinion` (`idOpinion`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `site`
--
ALTER TABLE `site`
  ADD CONSTRAINT `fk_Site_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Site_Pays1` FOREIGN KEY (`idPays`) REFERENCES `pays` (`idPays`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `sorties`
--
ALTER TABLE `sorties`
  ADD CONSTRAINT `fk_Sorties_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Sorties_Pays1` FOREIGN KEY (`idPays`) REFERENCES `pays` (`idPays`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Sorties_Plateform1` FOREIGN KEY (`idPlateform`) REFERENCES `plateform` (`idPlateform`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `supports`
--
ALTER TABLE `supports`
  ADD CONSTRAINT `fk_Supports_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `tag`
--
ALTER TABLE `tag`
  ADD CONSTRAINT `fk_Tag_Media1` FOREIGN KEY (`idMedia`) REFERENCES `media` (`idMedia`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `test`
--
ALTER TABLE `test`
  ADD CONSTRAINT `fk_Test_Entete1` FOREIGN KEY (`idEntete`) REFERENCES `entete` (`idEntete`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Test_Jeu1` FOREIGN KEY (`idJeu`) REFERENCES `jeu` (`idJeu`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Test_Plateform1` FOREIGN KEY (`idPlateform`) REFERENCES `plateform` (`idPlateform`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `themes`
--
ALTER TABLE `themes`
  ADD CONSTRAINT `fk_Themes_Information1` FOREIGN KEY (`idInformation`) REFERENCES `information` (`idInformation`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Contraintes pour la table `typemedia`
--
ALTER TABLE `typemedia`
  ADD CONSTRAINT `fk_TypeMedia_Media1` FOREIGN KEY (`idMedia`) REFERENCES `media` (`idMedia`) ON DELETE CASCADE ON UPDATE NO ACTION;
