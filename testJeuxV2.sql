...
CREATE TABLE IF NOT EXISTS `mydb`.`Plateform` (
  ...
  `idSorties` INT NOT NULL,
  PRIMARY KEY (`idPlateform`),
  INDEX `fk_Plateform_Sorties1_idx` (`idSorties` ASC),
  CONSTRAINT `fk_Plateform_Sorties1`
    FOREIGN KEY (`idSorties`)
    REFERENCES `mydb`.`Sorties` (`idSorties`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
